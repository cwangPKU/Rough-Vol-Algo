function result_struct = testConvergenceJ(nList, nf, H, T, JList, refPrice)
    num_n = numel(nList);
    num_J = numel(JList);
    theta = 0.05;
    rho = -0.1;
    ...
    result_struct = repmat(struct('n', [], 'nf', [], 'J', [],...
        't', [], 'ref', [], 'price', [], 'rmse', [], 'se', [], 'bias', []), num_n * num_J, 1);
    for k1 = 1 : num_J
        J = JList(k1);
        fprintf("Testing J = %d...\n", J);
